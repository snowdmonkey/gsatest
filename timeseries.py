...
def coefficient_product(c1=None, c2=None, p1=1, p2=1):
    """
...
class ArimaTS(TimeSeries):
    ...
    def calculate_epsilon_list(self):
        ...
        self.epsilon_list = filter_series(x_series=u_series,
...
class TransferFunctionTS(TimeSeries):
    ...
    def calculate_v_series(self):
        for i in range(self.k):
            ...
            u_series = differ_series(x_series, d=transfer_function.d, D=transfer_function.D, s=transfer_function.s)
            v_series = filter_series(x_series=u_series,
    ...
    def calculate_n_series(self):
        n_series = []
        delta_z_series = differ_series(series=self.data, d=self.model.d, D=self.model.D, s=self.model.s)
