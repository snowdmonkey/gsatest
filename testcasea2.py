...
c = cplex.Cplex()
c.variables.add(names=['y'+str(i) for i in range(105, 129)], lb=[-cplex.infinity]*24)
for i in range(ts.k):
    c.variables.add(names=['x'+str(i)+'_'+str(j) for j in range(105, 129)], lb=[-cplex.infinity]*24)
    c.variables.add(names=['v'+str(i)+'_'+str(j) for j in range(105, 129)], lb=[-cplex.infinity]*24)
...
print 'y series:'
print_latex([c.solution.get_values('y'+str(i)) for i in range(105, 129)])
print_latex(ts.data[105:129])


print '-------------------------'
print 'x0 series'
print_latex([c.solution.get_values('x0_'+str(i)) for i in range(105, 129)])
print_latex(ts.x_series_list[0].data[105:129])


print '----------------------------'
print 'x1 series'
print_latex([c.solution.get_values('x1_'+str(i)) for i in range(105, 129)])
print_latex(ts.x_series_list[1].data[105:129])


print '-------------------------------'
print 'x2 series'
print_latex([c.solution.get_values('x2_'+str(i)) for i in range(105, 129)])
print_latex(ts.x_series_list[2].data[105:129])


print '----------------------------------'
print 'v0 series'
print_latex([c.solution.get_values('v0_'+str(i)) for i in range(105, 129)])
print_latex(ts.v_series_list[0][105:129])


print '----------------------------------'
print 'v1 series'
print_latex([c.solution.get_values('v1_'+str(i)) for i in range(105, 129)])
print_latex(ts.v_series_list[1][105:129])


print '----------------------------------'
print 'v2 series'
print_latex([c.solution.get_values('v2_'+str(i)) for i in range(105, 129)])
print_latex(ts.v_series_list[2][105:129])
