...
a test on gsa
target: revenue B
predictor: Email_Offer, Direct_Mail_Offer
"""
...
ts = TcmTS(data=revenue['Product_B_Revenue'].get_values().tolist()[:-12], x_series_number=2)
...
with open('model/model_B.txt') as f:
    lines = f.readlines()
...
target = {123: 22000, }  # target for y series in format position:target value
